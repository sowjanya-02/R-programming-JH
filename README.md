# R-programming-JH
functions to calculate mean,number of complete observations and correlations
First function describes as follows:
function named 'pollutantmean' that calculates the mean of a pollutant (sulfate or nitrate) across a specified list of monitors. 
